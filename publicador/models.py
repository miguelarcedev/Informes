...
class Publicador(models.Model):
    ...
    a_sm = models.CharField(max_length=20, choices=ASM, null=True, blank=True, default="")
    servicio = models.CharField(max_length=20, choices=SERVICIO, null=True, blank=True, default="")
    ...
    contacto = models.CharField(max_length=50, null=True, blank=True, default="")
